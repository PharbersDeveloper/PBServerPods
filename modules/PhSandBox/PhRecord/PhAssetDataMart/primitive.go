...
func writeAssetDataMart(r *AssetDataMart, w io.Writer) error {
	var err error
	err = writeString(r.AssetName, w)
	if err != nil {
		return err
	}
	err = writeString(r.AssetDescription, w)
	if err != nil {
		return err
	}
	err = writeString(r.AssetVersion, w)
	if err != nil {
		return err
	}
	err = writeString(r.AssetDataType, w)
	if err != nil {
		return err
	}
	...
	err = writeArrayString(r.Dfs, w)
	if err != nil {
		return err
	}
	err = writeString(r.MartName, w)
	if err != nil {
		return err
	}
	err = writeString(r.MartUrl, w)
	if err != nil {
		return err
	}
	err = writeString(r.MartDataType, w)
	if err != nil {
		return err
	}
